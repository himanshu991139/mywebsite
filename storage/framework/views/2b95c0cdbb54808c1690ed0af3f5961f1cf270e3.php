            ...
            <div class="modal-body">
                ...
                <ul class="clearfix">
                    ...
                    <li class="float-left"><a href="#"><i class="fa fa-google-plus" aria-hidden="true"></i>
                            Google</a></li>
                    <li class="float-left"><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i> Twitter</a>
                    </li>
...
</div> <!-- /.signInModal --><?php /**PATH /Users/kapilanandd/onlineHomeTution/resources/views/layout/modal.blade.php ENDPATH**/ ?>