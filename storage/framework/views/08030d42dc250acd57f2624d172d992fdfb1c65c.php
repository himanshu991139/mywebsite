...
<div class="container">
    <div class="body-colo">
        <div class="text-margin">
            <h3><u>Are you confuse to choose the programming languange? to start your carrier in computer science field this blog will help you out to reslve your confussion and get started your carrier.</u></h3> <br>
            <p>The main thing that was bother a lot of student is to What should they learn, where should they start? What should they know to get  first job as a programmer?.Beginners are stuck at the choice, there isn’t a straight path to become a good programmer and the community isn’t so warm in welcoming the newbie questions like “is python is a good  languange to start with???”.
            ...
            <h4>What Languange,Technology or Skill??</h4>
            <p>
            ...
            <ul>
                <li><b>Web Development</b> (Google Search, Facebook, Amazon, Twitter and others)
                </li>
                <li><b>Desktop Application</b> (Dropbox, Photoshop, Visual Studio, Skype and others)</li>
                <li><b>Mobile App</b> (Youtube, Instagram, Uber and others)</li>
            </ul>
            Most of the Services exist for various platform like Amazon is Web Development,Mobile App and Dekstop Application
            </p>
            <p>
            <h4>WEB DEVELOPMENT</h4>
            <p>Web development broadly refers to the tasks associated with developing websites for hosting via intranet or internet. The web development process includes web design, web content development, client-side/server-side scripting and network security configuration, among other tasks.<br>

                Web development is also known as <u>website development.</u>
                <br>
            ...
            <li><h4>Back end:-</h4>
                <p>The classic set of backend technologies (the “technology stack”) is called LAMP. It is an acronym that stands for Linux (operating system), Apache (server), MySQL (database), PHP (server-side language).
            ...
            <img src="images/local/mostdemandedwebdecelopment.png">
            <h4>Dekstop Application </h4>
            <p>
...
</html><?php /**PATH C:\Users\Hamar-PC\Desktop\hometutor\resources\views/where.blade.php ENDPATH**/ ?>